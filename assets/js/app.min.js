...
!(function (e, t) {
    ...
    s.isMobileDevice = !(!i && !n);
    !(function () {
        var t,
            s = navigator.pointerEnabled || navigator.msPointerEnabled,
            i = "ontouchstart" in window || (window.DocumentTouch && document instanceof window.DocumentTouch),
            n = {},
            a = "jcf-";
        (t = s
            ...
            : { pointerover: "mouseover", pointerdown: "mousedown" + (i ? " touchstart" : ""), pointermove: "mousemove" + (i ? " touchmove" : ""), pointerup: "mouseup" + (i ? " touchend" : "") }),
            e.each(t, function (t, s) {
                e.each(s.split(" "), function (e, s) {
                    n[s] = t;
                });
            }),
            e.each(t, function (t, s) {
                    ...
                    (e.event.special[a + t] = {
                        setup: function () {
                            ...
                            e.each(s, function (e, s) {
                                t.addEventListener ? t.addEventListener(s, o, !1) : (t["on" + s] = o);
                            });
                        },
                        teardown: function () {
                            var t = this;
                            e.each(s, function (e, s) {
                                t.addEventListener ? t.removeEventListener(s, o, !1) : (t["on" + s] = null);
                            });
                        },
                    });
            });
        var r = null,
            o = function (t) {
                var s = t || window.event,
                    i = null,
                    o = n[s.type];
                if ((((t = e.event.fix(s)).type = a + o), s.pointerType))
                    switch (s.pointerType) {
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            t.pointerType = s.pointerType;
                    }
                else t.pointerType = s.type.substr(0, 5);
                return (
                    t.pageX || t.pageY || ((i = s.changedTouches ? s.changedTouches[0] : s), (t.pageX = i.pageX), (t.pageY = i.pageY)),
                    "touchend" === s.type && (r = { x: t.pageX, y: t.pageY }),
                    "mouse" === t.pointerType &&
                    r &&
                    (function (e) {
                        var t = Math.abs(e.pageX - r.x),
                            s = Math.abs(e.pageY - r.y);
                        return (25 >= t && 25 >= s) || void 0;
                    })(t)
                        ? void 0
        ...
        (function () {
            ...
            var i = function (t) {
                ...
                if (
                    (((t = e.event.fix(i)).type = s),
                    "detail" in i && (t.deltaY = -i.detail),
                    "wheelDelta" in i && (t.deltaY = -i.wheelDelta),
                    "wheelDeltaY" in i && (t.deltaY = -i.wheelDeltaY),
                    "wheelDeltaX" in i && (t.deltaX = -i.wheelDeltaX),
                    "deltaY" in i && (t.deltaY = i.deltaY),
                    "deltaX" in i && (t.deltaX = i.deltaX),
    ...
    var a = {
            fireNativeEvent: function (t, s) {
                e(t).each(function () {
                    var e,
                        t = this;
                    t.dispatchEvent ? ((e = document.createEvent("HTMLEvents")).initEvent(s, !0, !0), t.dispatchEvent(e)) : document.createEventObject && (((e = document.createEventObject()).target = t), t.fireEvent("on" + s, e));
                });
            },
        ...
        r = {
            ...
            setOptions: function (t, i) {
                arguments.length > 1 ? this.modules[t] && e.extend(this.modules[t].prototype.options, i) : e.extend(s, t);
            },
            addModule: function (i) {
                e.isFunction(i) && (i = i(e, window));
                var n = function (i) {
                        i.element.data(s.dataKey) || i.element.data(s.dataKey, this), t.push(this), (this.options = e.extend({}, s, this.options, r(i.element), i)), this.bindHandlers(), this.init.apply(this, arguments);
                    },
                    r = function (t) {
                        var i = t.data(s.optionsKey),
                            n = t.attr(s.optionsKey);
                        if (i) return i;
                        if (n)
                            try {
                ...
                (n.prototype = i),
                    e.extend(i, a),
                    i.plugins &&
                        e.each(i.plugins, function (t, s) {
                            e.extend(s.prototype, a);
                        });
                var o = n.prototype.destroy;
                (n.prototype.destroy = function () {
                    ...
                    (this.modules[i.name] = n);
            },
            getInstance: function (t) {
                return e(t).data(s.dataKey);
            },
                ...
                return (
                    s.styleSheetCreated ||
                        (function () {
                            var t = e("<style>").appendTo("head"),
                                ...
                                n = function (e, t, s) {
                                    (s = s || 0), i.insertRule ? i.insertRule(e + "{" + t + "}", s) : i.addRule(e, t, s);
                                };
                            n(
                                "." + s.hiddenClass,
                                "position:absolute !important;left:-9999px !important;height:1px !important;width:1px !important;margin:0 !important;border-width:0 !important;-webkit-appearance:none;-moz-appearance:none;appearance:none"
                            ),
                                n("." + s.rtlClass + " ." + s.hiddenClass, "right:-9999px !important; left: auto !important"),
                                n("." + s.unselectableClass, "-webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; -webkit-tap-highlight-color: rgba(0,0,0,0);"),
                                n("." + s.resetAppearanceClass, "background: none; border: none; -webkit-appearance: none; appearance: none; opacity: 0; filter: alpha(opacity=0);");
                            var a = e("html"),
                                o = e("body");
                            ("rtl" !== a.css("direction") && "rtl" !== o.css("direction")) || a.addClass(s.rtlClass),
                                a.on("reset", function () {
                                    setTimeout(function () {
                                        r.refreshAll();
                                    }, 0);
                    ...
                    e(t).each(function () {
                        ...
                        (a = r.data(s.dataKey))
                            ? a.refresh()
                            : (i ||
                                  e.each(o.modules, function (e, t) {
                                      return t.prototype.matchElement.call(t.prototype, r) ? ((i = e), !1) : void 0;
                                  }),
                              i && ((t = e.extend({ element: r }, n)), (a = new o.modules[i](t))));
                    }),
                    a
                );
            },
            ...
            replaceAll: function (t) {
                var s = this;
                e.each(this.modules, function (i, n) {
                    e(n.prototype.selector, t).each(function () {
                        this.className.indexOf("jcf-ignore") < 0 && s.replace(this, i);
                    });
                });
            },
            refreshAll: function (i) {
                if (i)
                    e.each(this.modules, function (t, n) {
                        e(n.prototype.selector, i).each(function () {
                            var t = e(this).data(s.dataKey);
                            t && t.refresh();
                        });
                    });
                else for (var n = t.length - 1; n >= 0; n--) t[n].refresh();
            },
            destroyAll: function (i) {
                if (i)
                    e.each(this.modules, function (t, n) {
                        e(n.prototype.selector, i).each(function (t, i) {
                            var n = e(i).data(s.dataKey);
                            n && n.destroy();
                        });
                    });
    ...
    (function (e) {
        e.addModule(function (t, s) {
            ...
            var r = {
                ...
                plugins: { ListBox: n, ComboBox: i, SelectList: a },
            ...
            t.extend(i.prototype, {
                ...
                attachEvents: function () {
                    ...
                    (this.delayedRefresh = function () {
                        ...
                        this.options.wrapNative
                            ? this.realElement.on({ focus: this.onFocus, change: this.onChange, click: this.onChange, keydown: this.delayedRefresh })
                ...
                toggleListMode: function (e) {
                    this.options.wrapNative || (e ? this.realElement.attr({ size: 4, "jcf-size": "" }) : this.options.wrapNative || this.realElement.removeAttr("size jcf-size"));
                },
                ...
                repositionDropdown: function () {
                    var e,
                        ...
                        n = this.fakeElement[0].getBoundingClientRect(),
                        a = n.width || n.right - n.left,
                        r = this.fakeElement.outerHeight(),
                        o = this.dropdown.css("width", a).outerHeight(),
                        l = this.win.scrollTop(),
                        h = this.win.height(),
                        c = !1;
                    i.top + r + o > l + h && i.top - o > l && (c = !0),
                        this.options.fakeDropInBody &&
                            ((s = "static" !== this.fakeDropTarget.css("position") ? this.fakeDropTarget.offset().top : 0),
                            this.options.flipDropToFit && c ? ((t = i.left), (e = i.top - o - s)) : ((t = i.left), (e = i.top + r - s)),
                            this.dropdown.css({ width: a, left: t, top: e })),
                ...
                refreshSelectedText: function () {
                    ...
                    this.realElement.prop("multiple")
                        ...
                        : i
                        ? (this.currentSelectedText === i.innerHTML && this.currentSelectedImage === n) ||
                          ((e = o(i.className, this.options.optionClassPrefix)),
                ...
                t.extend(n.prototype, {
                    ...
                    initStructure: function () {
                        (this.realElement = t(this.options.element)),
                            ...
                            (this.list = new a({ useCustomScroll: this.options.useCustomScroll, holder: this.listHolder, selectOnClick: !1, element: this.realElement }));
                    },
                    attachEvents: function () {
                        var e = this;
                ...
                t.extend(a.prototype, {
                    ...
                    rebuildList: function () {
                        ...
                        var n = this.options.maxVisibleItems,
                            a = this.element.prop("size");
                        a > 1 && !this.element.is("[jcf-size]") && (n = a);
                        var r = this.fakeOptions.length > n;
                        return (
                            this.container.toggleClass(this.options.scrollClass, r),
                            r && (this.listHolder.css({ maxHeight: this.getOverflowHeight(n), overflow: "auto" }), this.options.useCustomScroll && e.modules.Scrollable)
                                ? void e.replace(this.listHolder, "Scrollable", { handleResize: this.options.handleResize, alwaysPreventMouseWheel: this.options.alwaysPreventMouseWheel })
                                : void (
                        ...
                        return this.element.prop("multiple")
                            ? ((this.currentSelection = this.getSelectedOptionsIndexes()),
                              t.each(this.currentSelection, function (e, t) {
                                  !i && s.previousSelection.indexOf(t) < 0 && (0 === e && (i = !0), (n = t));
                              }),
                    ...
                    getActiveOptionOffset: function () {
                        ...
                        if (null !== e) {
                            var t = this.listHolder.height(),
                                ...
                                n = i.offset().top - this.list.offset().top,
                                a = i.innerHeight();
                            return n + a >= s + t ? n - t + a : s > n ? n : void 0;
                        }
                    },
                    ...
                    createOption: function (e) {
                        ...
                        return (
                            i && (((s = document.createElement("img")).src = i), t.insertBefore(s, t.childNodes[0])),
                            e.disabled && (t.className += " " + this.options.disabledClass),
                            e.className && (t.className += " " + o(e.className, this.options.cloneClassPrefix)),
                            t
                        );
                    },
                    createOptGroup: function (e) {
                        ...
                        return (
                            ((t = document.createElement("span")).className = this.options.captionClass),
                            (t.innerHTML = n),
                            i.appendChild(t),
                            e.children.length && ((s = this.createOptionsList(e)), i.appendChild(s)),
                    ...
                    createOptionsList: function (e) {
                        ...
                        return (
                            t.each(e.children, function (e, t) {
                                var n,
                                    a = s.createOptionContainer(t);
                                switch (t.tagName.toLowerCase()) {
                                    case "option":
                                        n = s.createOption(t);
                                        break;
                                    case "optgroup":
                                        n = s.createOptGroup(t);
                                }
                                i.appendChild(a).appendChild(n);
                            }),
                            i
                        );
                    },
    ...
    jcf.addModule(function (e) {
        ...
        return {
            ...
            refresh: function () {
                ...
                this.fakeElement.toggleClass(this.options.checkedClass, e).toggleClass(this.options.uncheckedClass, !e).toggleClass(this.options.disabledClass, t),
                    this.labelElement && this.labelElement.toggleClass(this.options.labelActiveClass, e);
            },
            destroy: function () {
                ...
                onFakeClick: function (e) {
                    (this.options.wrapNative && this.realElement.is(e.target)) ||
                        ...
                        this.savedEventObject && this.savedEventObject.isDefaultPrevented()
                            ? (this.realElement.prop("checked", this.stateChecked), this.currentActiveRadio.prop("checked", !0))
        ...
        return {
            ...
            initStructure: function () {
                (this.page = e("html")),
                    ...
                    (this.minValue = isNaN(this.minValue) ? -1 / 0 : this.minValue),
                    (this.maxValue = isNaN(this.maxValue) ? 1 / 0 : this.maxValue),
                    isFinite(this.maxValue) && (this.maxValue -= (this.maxValue - this.minValue) % this.stepValue);
            },
            attachEvents: function () {
                this.realElement.on({ focus: this.onFocus }), this.btnDec.add(this.btnInc).on("jcf-pointerdown", this.onBtnPress);
            },
            onBtnPress: function (e) {
                var t,
                    s = this;
                this.realElement.is(":disabled") ||
                    ((t = this.btnInc.is(e.currentTarget)),
                    s.step(t),
            ...
            onFocus: function () {
                this.fakeElement.addClass(this.options.focusClass), this.realElement.on({ blur: this.onBlur, keydown: this.onKeyPress });
            },
            onBlur: function () {
                this.fakeElement.removeClass(this.options.focusClass), this.realElement.off({ blur: this.onBlur, keydown: this.onKeyPress });
            },
            ...
            step: function (e) {
                var t = parseFloat(this.realElement.val()),
                    s = t || 0,
                    i = this.stepValue * (e ? 1 : -1),
                    n = isFinite(this.minValue) ? this.minValue : this.initialValue - Math.abs(s * this.stepValue),
                    a = Math.abs(n - s) % this.stepValue;
                a ? (e ? (s += i - a) : (s -= a)) : (s += i), s < this.minValue ? (s = this.minValue) : s > this.maxValue && (s = this.maxValue), s !== t && (this.realElement.val(s).trigger("change"), this.refresh());
            },
            refresh: function () {
            ...
            destroy: function () {
                this.realElement.removeClass(this.options.realElementClass).insertBefore(this.fakeElement),
                    ...
                    this.realElement.off({ keydown: this.onKeyPress, focus: this.onFocus, blur: this.onBlur });
            },
        };
    }),
    jcf.addModule(function (e) {
        ...
        return {
            ...
            updateExtensionClass: function () {
                var e = this.getFileExtension(),
                    t = this.fakeElement.prop("className").replace(new RegExp("(\\s|^)" + this.options.extensionPrefixClass + "[^ ]+", "gi"), "");
                this.fakeElement.prop("className", t), e && this.fakeElement.addClass(this.options.extensionPrefixClass + e);
            },
            refresh: function () {
    ...
    jcf.addModule(function (e) {
        ...
        return {
            ...
            attachEvents: function () {
                this.realElement.on({ focus: this.onFocus }), this.trackHolder.on("jcf-pointerdown", this.onTrackPress), this.handles.on("jcf-pointerdown", this.onHandlePress);
            },
            createDataList: function () {
                var t = this,
                    s = [],
                    i = this.realElement.attr("list");
                i &&
                    (e("#" + i)
                        .find("option")
                        .each(function () {
                            ...
                            isNaN(n) ||
                                ((i = t.valueToOffset(n)),
                                s.push({ value: n, offset: i }),
                                e(t.options.dataListMark)
                                    .text(n)
                                    .attr({ "data-mark-value": n })
                ...
                return (
                    this.handleCount > 1 &&
                        this.handles.each(function () {
                            var a = parseFloat(this.style[n.offsetProperty]) / 100,
                                r = Math.abs(a - t);
                            i > r && ((i = r), (s = e(this)));
                        }),
                    s
            ...
            onTrackPress: function (e) {
                ...
                e.preventDefault(),
                    this.realElement.is(":disabled") ||
                        ...
                        (i = this.activeDragHandle[this.sizeMethod]() / 2),
                        (this.dragData = { trackSize: t, innerOffset: i, trackOffset: s, min: s, max: s + t }),
                        this.page.on({ "jcf-pointermove": this.onHandleMove, "jcf-pointerup": this.onHandleRelease }),
            ...
            onHandlePress: function (t) {
                ...
                t.preventDefault(),
                    this.realElement.is(":disabled") ||
                        ...
                        (i = this.track.offset()[this.directionProperty]),
                        (n = this.options.dragHandleCenter ? this.activeDragHandle[this.sizeMethod]() / 2 : t[this.eventProperty] - this.handle.offset()[this.directionProperty]),
                        (this.dragData = { trackSize: s, innerOffset: n, trackOffset: i, min: i, max: i + s }),
                        this.page.on({ "jcf-pointermove": this.onHandleMove, "jcf-pointerup": this.onHandleRelease }),
            ...
            onHandleMove: function (t) {
                var s,
                    ...
                    o = this;
                if (
                    ((s = this.isVertical ? this.dragData.max + (this.dragData.min - t[this.eventProperty]) - this.dragData.innerOffset : t[this.eventProperty] - this.dragData.innerOffset) < this.dragData.min
                        ? (s = this.dragData.min)
                        : s > this.dragData.max && (s = this.dragData.max),
                    t.preventDefault(),
                    this.options.snapToMarks && this.dataValues)
                ) {
                    var l = s - this.dragData.trackOffset;
                    (i = ((s - this.dragData.trackOffset) / this.dragData.trackSize) * 100),
                        e.each(this.dataValues, function (e, t) {
                            var s = (t.offset / 100) * o.dragData.trackSize,
                                n = s - o.options.snapRadius,
                                a = s + o.options.snapRadius;
                            return l >= n && a >= l ? ((i = t.offset), !1) : void 0;
                        });
                } else i = ((s - this.dragData.trackOffset) / this.dragData.trackSize) * 100;
                (n = Math.round((i * this.stepsCount) / 100)),
                    this.handleCount > 1 && (n < (r = this.getDragHandleRange(this.activeDragHandleIndex)).minStepIndex ? (n = Math.max(r.minStepIndex, n)) : n > r.maxStepIndex && (n = Math.min(r.maxStepIndex, n))),
                    (a = n * (100 / this.stepsCount)),
                    this.dragData.stepIndex !== n &&
                        ((this.dragData.stepIndex = n),
                        (this.dragData.offset = a),
                        this.activeDragHandle.css(this.offsetProperty, this.dragData.offset + "%"),
                        (this.values[this.activeDragHandleIndex] = "" + this.stepIndexToValue(n)),
                        this.updateValues(),
            ...
            onHandleRelease: function () {
                ...
                "number" == typeof this.dragData.offset && ((e = this.stepIndexToValue(this.dragData.stepIndex)), this.realElement.val(e).trigger("change")),
                    this.page.off({ "jcf-pointermove": this.onHandleMove, "jcf-pointerup": this.onHandleRelease }),
                    delete this.activeDragHandle,
                    delete this.dragData;
            },
            onFocus: function () {
                this.fakeElement.hasClass(this.options.focusClass) || (this.fakeElement.addClass(this.options.focusClass), this.realElement.on({ blur: this.onBlur, keydown: this.onKeyPress }));
            },
            onBlur: function () {
                this.fakeElement.removeClass(this.options.focusClass), this.realElement.off({ blur: this.onBlur, keydown: this.onKeyPress });
            },
            ...
            updateValues: function () {
                ...
                this.values.length > 1
                    ? (this.realElement.prop("valueLow", this.values[0]),
                      ...
                      this.realElement.val(e),
                      this.realElement.val() !== e && this.realElement.val(this.values[this.values.length - 1]))
                    : this.realElement.val(e),
                    this.updateRanges();
            },
                ...
                this.rangeMin && ((e = this.handles[0]), this.rangeMin.css(this.offsetProperty, 0).css(this.sizeProperty, e.style[this.offsetProperty])),
                    ...
                    this.rangeMid &&
                        this.handles.each(function (e, s) {
                            ...
                            e > 0 &&
                                ((i = t.handles[e - 1]),
                                ((n = t.rangeMid[e - 1]).style[t.offsetProperty] = i.style[t.offsetProperty]),
                                (n.style[t.sizeProperty] = parseFloat(s.style[t.offsetProperty]) - parseFloat(i.style[t.offsetProperty]) + "%"));
                        });
            },
            step: function (e) {
                ...
                isNaN(t) && (s = 0),
                    (s += e),
                    this.handleCount > 1 &&
                        (this.activeDragHandleIndex > 0 && (i = parseFloat(this.values[this.activeDragHandleIndex - 1]) + this.options.minRange),
                        this.activeDragHandleIndex < this.handleCount - 1 && (n = parseFloat(this.values[this.activeDragHandleIndex + 1]) - this.options.minRange)),
                    s > n ? (s = n) : i > s && (s = i),
                    s !== t && ((this.values[this.activeDragHandleIndex || 0] = "" + s), this.updateValues(), this.realElement.trigger("input").trigger("change"), this.setSliderValue(this.values));
            },
            ...
            setSliderValue: function (e) {
                var t = this;
                this.handles.each(function (s, i) {
                    i.style[t.offsetProperty] = t.valueToOffset(e[s]) + "%";
                });
            },
            refresh: function () {
                var e = this.realElement.is(":disabled");
            ...
            destroy: function () {
                this.realElement.removeClass(this.options.hiddenClass).insertBefore(this.fakeElement), this.fakeElement.remove(), this.realElement.off({ keydown: this.onKeyPress, focus: this.onFocus, blur: this.onBlur });
            },
        };
    }),
    (function (e) {
        ...
        e.fn.fitVids = function (t) {
            var s = { customSelector: null, ignore: null };
            ...
            return (
                ...
                this.each(function () {
                    ...
                    var i = ".fitvidsignore";
                    s.ignore && (i = i + ", " + s.ignore);
                    var n = e(this).find(t.join(","));
                    (n = (n = n.not("object object")).not(i)).each(function (t) {
                        var s = e(this);
                        if (!(s.parents(i).length > 0 || ("embed" === this.tagName.toLowerCase() && s.parent("object").length) || s.parent(".fluid-width-video-wrapper").length)) {
                            s.css("height") || s.css("width") || (!isNaN(s.attr("height")) && !isNaN(s.attr("width"))) || (s.attr("height", 9), s.attr("width", 16));
                            var n =
                                ("object" === this.tagName.toLowerCase() || (s.attr("height") && !isNaN(parseInt(s.attr("height"), 10))) ? parseInt(s.attr("height"), 10) : s.height()) /
                                (isNaN(parseInt(s.attr("width"), 10)) ? s.width() : parseInt(s.attr("width"), 10));
                            if (!s.attr("id")) {
                                var a = "fitvid" + t;
                                s.attr("id", a);
                            }
                            s
                                ...
                                s.removeAttr("height").removeAttr("width");
                        }
                    });
                })
            );
    ...
    (function (e) {
        ...
        e.HTMLPictureElement &&
            ...
            addEventListener(
                ...
                (o = function () {
                    a(), r && r.addListener && r.addListener(a);
                }),
    ...
    (function (e, t, s) {
        ...
        var r = {},
            ...
            v = /rident/.test(g) || (/ecko/.test(g) && g.match(/rv\:(\d+)/) && RegExp.$1 > 35),
            C = "currentSrc",
            E = /\s+\+?\d+(e\d+)?w/,
            b = /(\([^)]+\))?\s*(.+)/,
            y = e.picturefillCFG,
            ...
            L = function (e, t, s, i) {
                e.addEventListener ? e.addEventListener(t, s, i || !1) : e.attachEvent && e.attachEvent("on" + t, s);
            },
            N = function (e) {
                var t = {};
                return function (s) {
        ...
        var z,
            ...
            te =
                ...
                function (e, t) {
                    var s;
                    if (!(e in x))
                        if (((x[e] = !1), t && (s = e.match(z)))) x[e] = s[1] * T[s[2]];
                        else
                            try {
                                x[e] = new Function("e", B(e))(T);
                            } catch (e) {}
                    return x[e];
                }),
            se = function (e, t) {
            ...
            ie = function (e) {
                if (o) {
                    var s,
                        ...
                        a = e || {};
                    if (
                        (a.elements && 1 === a.elements.nodeType && ("IMG" === a.elements.nodeName.toUpperCase() ? (a.elements = [a.elements]) : ((a.context = a.elements), (a.elements = null))),
                        (n = (s = a.elements || r.qsa(a.context || t, a.reevaluate || a.reselect ? r.sel : r.selShort)).length))
                    ) {
                        for (r.setupRun(a), D = !0, i = 0; i < n; i++) r.fillImg(s[i], a);
                        r.teardownRun(a);
                    }
                }
            };
        ...
        function ae(e, t) {
            var s, i, n;
            if (e && t)
                for (n = r.parseSet(t), e = r.makeUrl(e), s = 0; s < n.length; s++)
                    if (e === r.makeUrl(n[s].url)) {
                        i = n[s];
                        break;
                    }
            return i;
        ...
        e.console && console.warn,
            ...
            (f["image/gif"] = !0),
            (f["image/png"] = !0),
            (f["image/svg+xml"] = t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1")),
            (r.ns = ("pf" + new Date().getTime()).substr(0, 9)),
            (r.supSrcset = "srcset" in h),
            (r.supSizes = "sizes" in h),
            (r.supPicture = !!e.HTMLPictureElement),
            r.supSrcset && r.supPicture && !r.supSizes && ((V = t.createElement("img")), (h.srcset = "data:,a"), (V.src = "data:,a"), (r.supSrcset = h.complete === V.complete), (r.supPicture = r.supSrcset && r.supPicture)),
            r.supSrcset && !r.supSizes
                ? ((q = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
                  (K = t.createElement("img")),
                  (W = function () {
                      2 === K.width && (r.supSizes = !0), (n = r.supSrcset && !r.supSizes), (o = !0), setTimeout(ie);
                  }),
                  (K.onload = W),
                  (K.onerror = W),
                  K.setAttribute("sizes", "9px"),
                  (K.srcset = q + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w"),
                  (K.src = q))
                : (o = !0),
            (r.selShort = "picture>img,img[srcset]"),
            (r.sel = r.selShort),
            (r.cfg = m),
            (r.DPR = A || 1),
            (r.u = T),
            ...
            (r.matchesMedia = function () {
                return (
                    e.matchMedia && (matchMedia("(min-width: 0.1em)") || {}).matches
                        ...
                        : (r.matchesMedia = r.mMQ),
                    r.matchesMedia.apply(this, arguments)
                );
            }),
            (r.mMQ = function (e) {
                return !e || te(e);
                ...
                return (
                    e.cands ||
                        (e.cands = (function (e, t) {
                            function s(t) {
                                var s,
                                    i = t.exec(e.substring(h));
                                if (i) return (s = i[0]), (h += s.length), s;
                            }
                            var i,
                                n,
                                a,
                            ...
                            function d() {
                                ...
                                for (r = 0; r < n.length; r++)
                                    (l = (o = n[r])[o.length - 1]),
                                        (h = o.substring(0, o.length - 1)),
                                        (d = parseInt(h, 10)),
                                        (u = parseFloat(h)),
                                        M.test(h) && "w" === l
                                            ? ((e || s) && (p = !0), 0 === d ? (p = !0) : (e = d))
                                            : P.test(h) && "x" === l
                                            ? ((e || s || a) && (p = !0), u < 0 ? (p = !0) : (s = u))
                                            : M.test(h) && "h" === l
                                            ? ((a || s) && (p = !0), 0 === d ? (p = !0) : (a = d))
                                            : (p = !0);
                                p || ((f.url = i), e && (f.w = e), s && (f.d = s), a && (f.h = a), a || s || e || (f.d = 1), 1 === f.d && (t.has1x = !0), (f.set = t), c.push(f));
                            }
                            function u() {
                                for (s(H), a = "", r = "in descriptor"; ; ) {
                                    if (((o = e.charAt(h)), "in descriptor" === r))
                                        if (O(o)) a && (n.push(a), (a = ""), (r = "after descriptor"));
                                        else {
                                            if ("," === o) return (h += 1), a && n.push(a), void d();
                                            if ("(" === o) (a += o), (r = "in parens");
                                            else {
                                                if ("" === o) return a && n.push(a), void d();
                                                a += o;
                                            }
                                        }
                                    else if ("in parens" === r)
                                        if (")" === o) (a += o), (r = "in descriptor");
                                        else {
                                            if ("" === o) return n.push(a), void d();
                                            a += o;
                                        }
                            ...
                            for (;;) {
                                if ((s(F), h >= l)) return c;
                                (i = s(R)), (n = []), "," === i.slice(-1) ? ((i = i.replace(I, "")), d()) : u();
                            }
                        })(e.srcset, e)),
                    e.cands
                );
            ...
            (r.getEmValue = function () {
                ...
                if (!i && (e = t.body)) {
                    var s = t.createElement("div"),
                        n = p.style.cssText,
                        a = e.style.cssText;
                    (s.style.cssText = "position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)"),
                        (p.style.cssText = w),
                        (e.style.cssText = w),
                        e.appendChild(s),
                        (i = s.offsetWidth),
                    ...
                    var t = r.calcLength(
                        (function (e) {
                            var t,
                                ...
                                o,
                                l,
                                h = /^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,
                                c = /^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;
                            for (
                                i = (s = (function (e) {
                                    var t,
                                    ...
                                    for (;;) {
                                        ...
                                        if (o) {
                                            ...
                                            if (O(t)) {
                                                if ((e.charAt(r - 1) && O(e.charAt(r - 1))) || !s) {
                                                    r += 1;
                                                    continue;
                                                }
                                                if (0 === a) {
                                ...
                                if (((a = (n = s[t])[n.length - 1]), (l = a), (h.test(l) && parseFloat(l) >= 0) || c.test(l) || "0" === l || "-0" === l || "+0" === l)) {
                                    if (((o = a), n.pop(), 0 === n.length)) return o;
                                    if (((n = n.join(" ")), r.matchesMedia(n))) return o;
                                }
                            return "100vw";
                        })(e)
                    );
            ...
            (r.setRes = function (e) {
                var t;
                if (e) for (var s = 0, i = (t = r.parseSet(e)).length; s < i; s++) se(t[s], e.sizes);
                return t;
            }),
            (r.setRes.res = se),
            (r.applySetCandidate = function (e, t) {
                if (e.length) {
                    var s,
                        i,
                        n,
                    ...
                    if (
                        ...
                        (h =
                            ...
                            (function (e, t, s) {
                                var i;
                                return !s && t && (s = (s = e[r.ns].sets) && s[s.length - 1]), (i = ae(t, s)) && ((t = r.makeUrl(t)), (e[r.ns].curSrc = t), (e[r.ns].curCan = i), i.res || se(i, i.set.sizes)), i;
                            })(t, l, e[0].set)) &&
                            h.set === e[0].set &&
                            ((d = v && !t.complete && h.res - 0.1 > k) || ((h.cached = !0), h.res >= k && (o = h))),
                        !o)
                    )
                        for (e.sort(ne), o = e[(a = e.length) - 1], i = 0; i < a; i++)
                            if ((s = e[i]).res >= k) {
                                o =
                                    e[(n = i - 1)] &&
                                    (d || l !== r.makeUrl(s.url)) &&
                                    ...
                                    (b = void 0),
                                    (y = void 0),
                                    "saveData" === m.algorithm ? (u > 2.7 ? (y = f + 1) : ((b = (p - f) * (E = Math.pow(u - 0.6, 1.5))), g && (b += 0.1 * E), (y = u + b))) : (y = f > 1 ? Math.sqrt(u * p) : u),
                                    y > f)
                                        ? e[n]
                                        : s;
                                break;
                            }
                    o && ((c = r.makeUrl(o.url)), (w.curSrc = c), (w.curCan = o), c !== l && r.setSrc(t, o), r.setSize(t));
                }
            }),
            ...
            (r.getSet = function (e) {
                ...
                for (t = 0; t < a.length && !n; t++)
                    if ((s = a[t]).srcset && r.matchesMedia(s.media) && (i = r.supportsType(s.type))) {
                        "pending" === i && (s = i), (n = s);
                        break;
                    }
                return n;
            ...
            (r.parseSets = function (e, t, s) {
                var i,
                    ...
                    o,
                    l,
                    h = t && "PICTURE" === t.nodeName.toUpperCase(),
                    p = e[r.ns];
                (void 0 === p.src || s.src) && ((p.src = c.call(e, "src")), p.src ? d.call(e, "data-pfsrc", p.src) : u.call(e, "data-pfsrc")),
                    (void 0 === p.srcset || s.srcset || !r.supSrcset || e.srcset) && ((i = c.call(e, "srcset")), (p.srcset = i), (l = !0)),
                    (p.sets = []),
                    h &&
                        ((p.pic = !0),
                        (function (e, t) {
                            ...
                            for (s = 0, i = o.length; s < i; s++)
                                ((n = o[s])[r.ns] = !0), (a = n.getAttribute("srcset")) && t.push({ srcset: a, media: n.getAttribute("media"), type: n.getAttribute("type"), sizes: n.getAttribute("sizes") });
                        })(t, p.sets)),
                    p.srcset
                        ? ((a = { srcset: p.srcset, sizes: c.call(e, "sizes") }),
                          p.sets.push(a),
                          (o = (n || p.src) && E.test(p.srcset || "")) || !p.src || ae(p.src, a) || a.has1x || ((a.srcset += ", " + p.src), a.cands.push({ url: p.src, d: 1, set: a })))
                        : p.src && p.sets.push({ srcset: p.src, sizes: null }),
                    (p.curCan = null),
                    (p.curSrc = void 0),
                    (p.supported = !(h || (a && !r.supSrcset) || (o && !r.supSizes))),
                    l && r.supSrcset && !p.supported && (i ? (d.call(e, "data-pfsrcset", i), (e.srcset = "")) : u.call(e, "data-pfsrcset")),
                    p.supported && !p.srcset && ((!p.src && e.src) || e.src !== r.makeUrl(p.src)) && (null === p.src ? e.removeAttribute("src") : (e.src = p.src)),
                    (p.parsed = !0);
            }),
            (r.fillImg = function (e, t) {
                ...
                e[r.ns] || (e[r.ns] = {}),
                    (s = e[r.ns]),
                    (i || s.evaled !== a) &&
                        ((s.parsed && !t.reevaluate) || r.parseSets(e, e.parentNode, t),
                        s.supported
                            ? (s.evaled = a)
                            : (function (e) {
                                  var t,
                                      s = r.getSet(e),
                                      i = !1;
                                  "pending" !== s && ((i = a), s && ((t = r.setRes(s)), r.applySetCandidate(t, e))), (e[r.ns].evaled = i);
                              })(e));
            }),
            (r.setupRun = function () {
                (D && !k && A === e.devicePixelRatio) ||
                    ((k = !1),
                    (A = e.devicePixelRatio),
                    (x = {}),
                    (S = {}),
                    (r.DPR = A || 1),
                    (T.width = Math.max(e.innerWidth || 0, p.clientWidth)),
                    (T.height = Math.max(e.innerHeight || 0, p.clientHeight)),
                    (T.vw = T.width / 100),
                    (T.vh = T.height / 100),
                    (a = [T.height, T.width, A].join("-")),
                    (T.em = r.getEmValue()),
                    (T.rem = T.em));
            }),
            r.supPicture
                ? ((ie = l), (r.fillImg = l))
                : ((X = e.attachEvent ? /d$|^c/ : /d$|^c|^i/),
                  (Z = function () {
                      var e = t.readyState || "";
                      (J = setTimeout(Z, "loading" === e ? 200 : 999)), t.body && (r.fillImgs(), ($ = $ || X.test(e)) && clearTimeout(J));
                  }),
                  (J = setTimeout(Z, t.body ? 9 : 99)),
                  (ee = p.clientHeight),
                  L(
                      e,
                      "resize",
                      ((U = function () {
                          (k = Math.max(e.innerWidth || 0, p.clientWidth) !== T.width || p.clientHeight !== ee), (ee = p.clientHeight), k && r.fillImgs();
                      }),
                      (Y = 99),
                      (_ = function () {
                          var e = new Date() - Q;
                          e < Y ? (G = setTimeout(_, Y - e)) : ((G = null), U());
                      }),
                      function () {
                          (Q = new Date()), G || (G = setTimeout(_, Y));
                      })
                  ),
                  L(t, "readystatechange", Z)),
            (r.picturefill = ie),
            (r.fillImgs = ie),
            (r.teardownRun = l),
            (ie._ = r),
            (e.picturefillCFG = {
                ...
                push: function (e) {
                    var t = e.shift();
                    "function" == typeof r[t] ? r[t].apply(r, e) : ((m[t] = e[0]), D && r.fillImgs({ reselect: !0 }));
                },
            });
    ...
    (function (e) {
        ...
        e.extend(e.fn, {
            validate: function (t) {
                if (this.length) {
                    ...
                    return (
                        ...
                        (s = new e.validator(t, this[0])),
                        e.data(this[0], "validator", s),
                        s.settings.onsubmit &&
                            (this.on("click.validate", ":submit", function (t) {
                                (s.submitButton = t.currentTarget), e(this).hasClass("cancel") && (s.cancelSubmit = !0), void 0 !== e(this).attr("formnovalidate") && (s.cancelSubmit = !0);
                            }),
                            this.on("submit.validate", function (t) {
                                function i() {
                                    var i, n;
                                    return (
                                        s.submitButton && (s.settings.submitHandler || s.formSubmitted) && (i = e("<input type='hidden'/>").attr("name", s.submitButton.name).val(e(s.submitButton).val()).appendTo(s.currentForm)),
                                        !(s.settings.submitHandler && !s.settings.debug) || ((n = s.settings.submitHandler.call(s, s.currentForm, t)), i && i.remove(), void 0 !== n && n)
                                    );
                                }
                                return s.settings.debug && t.preventDefault(), s.cancelSubmit ? ((s.cancelSubmit = !1), i()) : s.form() ? (s.pendingRequest ? ((s.formSubmitted = !0), !1) : i()) : (s.focusInvalid(), !1);
                            })),
                        s)
                    );
                }
                ...
                return (
                    e(this[0]).is("form")
                        ...
                        : ((i = []),
                          ...
                          this.each(function () {
                              (t = s.element(this) && t) || (i = i.concat(s.errorList));
                          }),
                          (s.errorList = i)),
                    t
                );
            ...
            rules: function (t, s) {
                ...
                if (null != h && (!h.form && c && ((h.form = this.closest("form")[0]), (h.name = this.attr("name"))), null != h.form)) {
                    if (t)
                        switch (((n = (i = e.data(h.form, "validator").settings).rules), (a = e.validator.staticRules(h)), t)) {
                            case "add":
                                e.extend(a, e.validator.normalizeRule(s)), delete a.messages, (n[h.name] = a), s.messages && (i.messages[h.name] = e.extend(i.messages[h.name], s.messages));
                                break;
                            case "remove":
                                return s
                                    ? ((l = {}),
                                      e.each(s.split(/\s/), function (e, t) {
                                          (l[t] = a[t]), delete a[t];
                                      }),
                                      l)
                                    : (delete n[h.name], a);
                    ...
                    return (
                        (r = e.validator.normalizeRules(e.extend({}, e.validator.classRules(h), e.validator.attributeRules(h), e.validator.dataRules(h), e.validator.staticRules(h)), h)).required &&
        ...
        e.extend(e.expr.pseudos || e.expr[":"], {
            ...
            (e.validator = function (t, s) {
                (this.settings = e.extend(!0, {}, e.validator.defaults, t)), (this.currentForm = s), this.init();
            }),
            (e.validator.format = function (t, s) {
                return 1 === arguments.length
                    ? function () {
                          var s = e.makeArray(arguments);
                          return s.unshift(t), e.validator.format.apply(this, s);
                      }
                    : (void 0 === s ||
                          (arguments.length > 2 && s.constructor !== Array && (s = e.makeArray(arguments).slice(1)),
            ...
            e.extend(e.validator, {
                defaults: {
                    ...
                    onkeyup: function (t, s) {
                        (9 === s.which && "" === this.elementValue(t)) || -1 !== e.inArray(s.keyCode, [16, 17, 18, 20, 35, 36, 37, 38, 39, 40, 45, 144, 225]) || ((t.name in this.submitted || t.name in this.invalid) && this.element(t));
                    },
                    onclick: function (e) {
                        e.name in this.submitted ? this.element(e) : e.parentNode.name in this.submitted && this.element(e.parentNode);
                    },
                    highlight: function (t, s, i) {
                        "radio" === t.type ? this.findByName(t.name).addClass(s).removeClass(i) : e(t).addClass(s).removeClass(i);
                    },
                    unhighlight: function (t, s, i) {
                        "radio" === t.type ? this.findByName(t.name).removeClass(s).addClass(i) : e(t).removeClass(s).addClass(i);
                    },
                },
                ...
                prototype: {
                    init: function () {
                        ...
                        e.each(this.settings.groups, function (t, s) {
                            ...
                            e.each(t, function (s, i) {
                                t[s] = e.validator.normalizeRule(i);
                            }),
                            e(this.currentForm)
                                .on(
                                ...
                                .on("click.validate", "select, option, [type='radio'], [type='checkbox']", n),
                                ...
                                : (this.prepareElement(a),
                                  ...
                                  (i = this.groups[a.name]) &&
                                      e.each(this.groups, function (e, t) {
                                          t === i && e !== a.name && (n = r.validationTargetFor(r.clean(r.findByName(e)))) && n.name in r.invalid && (r.currentElements.push(n), (o = r.check(n) && o));
                                      }),
                                  (s = !1 !== this.check(a)),
                                  (o = o && s),
                                  (this.invalid[a.name] = !s),
                        ...
                        return e(this.currentForm)
                            ...
                            .filter(function () {
                                ...
                                return (
                                    ...
                                    n && ((this.form = e(this).closest("form")[0]), (this.name = i)),
                                    this.form === t.currentForm && !(i in s || !t.objectLength(e(this).rules())) && ((s[i] = !0), !0)
                                );
                            });
                    },
                    clean: function (t) {
                    ...
                    elementValue: function (t) {
                        ...
                        return "radio" === a || "checkbox" === a
                            ...
                            ? t.validity.badInput
                                ...
                                : n.val()
                            : ((s = r ? n.text() : n.val()),
                              "file" === a ? ("C:\\fakepath\\" === s.substr(0, 12) ? s.substr(12) : (i = s.lastIndexOf("/")) >= 0 || (i = s.lastIndexOf("\\")) >= 0 ? s.substr(i + 1) : s) : "string" == typeof s ? s.replace(/\r/g, "") : s);
                    },
                    check: function (t) {
                        ...
                        for (i in ("function" == typeof r.normalizer ? (a = r.normalizer) : "function" == typeof this.settings.normalizer && (a = this.settings.normalizer), a && ((h = a.call(t, h)), delete r.normalizer), r)) {
                            n = { method: i, parameters: r[i] };
                            try {
                                if ("dependency-mismatch" === (s = e.validator.methods[i].call(this, h, t, n.parameters)) && 1 === o) {
                                    l = !0;
                                    continue;
                                }
                                if (((l = !1), "pending" === s)) return void (this.toHide = this.toHide.not(this.errorsFor(t)));
                                if (!s) return this.formatAndAdd(t, n), !1;
                            } catch (e) {
                                throw (
                    ...
                    customDataMessage: function (t, s) {
                        return e(t).data("msg" + s.charAt(0).toUpperCase() + s.substring(1).toLowerCase()) || e(t).data("msg");
                    },
                    ...
                    defaultMessage: function (t, s) {
                        "string" == typeof s && (s = { method: s });
                        var i = this.findDefined(
                                this.customMessage(t.name, s.method),
                                this.customDataMessage(t, s.method),
                                (!this.settings.ignoreTitle && t.title) || void 0,
                                e.validator.messages[s.method],
                                "<strong>Warning: No message defined for " + t.name + "</strong>"
                            ),
                            n = /\$?\{(\d+)\}/g;
                        return "function" == typeof i ? (i = i.call(this, s.parameters, t)) : n.test(i) && (i = e.validator.format(i.replace(n, "{$1}"), s.parameters)), i;
                    },
                    ...
                    defaultShowErrors: function () {
                        ...
                        for (e = 0; this.errorList[e]; e++)
                            (s = this.errorList[e]), this.settings.highlight && this.settings.highlight.call(this, s.element, this.settings.errorClass, this.settings.validClass), this.showLabel(s.element, s.message);
                    ...
                    showLabel: function (t, s) {
                        ...
                        o.length
                            ? (o.removeClass(this.settings.validClass).addClass(this.settings.errorClass), o.html(s))
                            : ((i = o = e("<" + this.settings.errorElement + ">")
                              ...
                              o.is("label")
                                  ...
                                  : 0 === o.parents("label[for='" + this.escapeCssMeta(l) + "']").length &&
                                    ((a = o.attr("id")),
                                    h ? h.match(new RegExp("\\b" + this.escapeCssMeta(a) + "\\b")) || (h += " " + a) : (h = a),
                                    e(t).attr("aria-describedby", h),
                                    (n = this.groups[t.name]) &&
                                        ((r = this),
                                        e.each(r.groups, function (t, s) {
                                            s === n && e("[name='" + r.escapeCssMeta(t) + "']", r.currentForm).attr("aria-describedby", o.attr("id"));
                                        })))),
                            !s && this.settings.success && (o.text(""), "string" == typeof this.settings.success ? o.addClass(this.settings.success) : this.settings.success(o, t)),
                    ...
                    optional: function (t) {
                        var s = this.elementValue(t);
                        return !e.validator.methods.required.call(this, s, t) && "dependency-mismatch";
                    },
                    startRequest: function (t) {
                        this.pending[t.name] || (this.pendingRequest++, e(t).addClass(this.settings.pendingClass), (this.pending[t.name] = !0));
                    },
                    stopRequest: function (t, s) {
                        this.pendingRequest--,
                            ...
                            s && 0 === this.pendingRequest && this.formSubmitted && this.form()
                                ...
                                : !s && 0 === this.pendingRequest && this.formSubmitted && (e(this.currentForm).triggerHandler("invalid-form", [this]), (this.formSubmitted = !1));
                    },
                    previousValue: function (t, s) {
                        return (s = ("string" == typeof s && s) || "remote"), e.data(t, "previousValue") || e.data(t, "previousValue", { old: null, valid: !0, message: this.defaultMessage(t, { method: s }) });
                    },
                    destroy: function () {
                        this.resetForm(),
                            e(this.currentForm)
                ...
                addClassRules: function (t, s) {
                    t.constructor === String ? (this.classRuleSettings[t] = s) : e.extend(this.classRuleSettings, t);
                },
                ...
                attributeRules: function (t) {
                    ...
                    for (s in e.validator.methods) "required" === s ? ("" === (i = t.getAttribute(s)) && (i = !0), (i = !!i)) : (i = a.attr(s)), this.normalizeAttributeRule(n, r, s, i);
                ...
                dataRules: function (t) {
                    var s,
                        ...
                        a = e(t),
                        r = t.getAttribute("type");
                    for (s in e.validator.methods) "" === (i = a.data("rule" + s.charAt(0).toUpperCase() + s.substring(1).toLowerCase())) && (i = !0), this.normalizeAttributeRule(n, r, s, i);
                    return n;
                },
                staticRules: function (t) {
                    var s = {},
                        i = e.data(t.form, "validator");
                    return i.settings.rules && (s = e.validator.normalizeRule(i.settings.rules[t.name]) || {}), s;
                },
                normalizeRules: function (t, s) {
                    return (
                            ...
                            if (!1 !== n) {
                                if (n.param || n.depends) {
                                    ...
                                    switch (typeof n.depends) {
                                        case "string":
                                            a = !!e(n.depends, s.form).length;
                                            break;
                                        case "function":
                                            a = n.depends.call(s, s);
                                    }
                                    a ? (t[i] = void 0 === n.param || n.param) : (e.data(s.form, "validator").resetElements(e(s)), delete t[i]);
                                }
                            } else delete t[i];
                        }),
                        e.each(t, function (e, i) {
                            t[e] = "function" == typeof i && "normalizer" !== e ? i(s) : i;
                        }),
                ...
                addMethod: function (t, s, i) {
                    (e.validator.methods[t] = s), (e.validator.messages[t] = void 0 !== i ? i : e.validator.messages[t]), s.length < 3 && e.validator.addClassRules(t, e.validator.normalizeRule(t));
                },
                methods: {
                    required: function (t, s, i) {
                        if (!this.depend(i, s)) return "dependency-mismatch";
                        if ("select" === s.nodeName.toLowerCase()) {
                            var n = e(s).val();
                            return n && n.length > 0;
                        }
                        return this.checkable(s) ? this.getLength(t, s) > 0 : null != t && t.length > 0;
                    },
                    email: function (e, t) {
                    ...
                    date:
                        ...
                        function (e, s) {
                            return (
                                ...
                                this.optional(s) || !/Invalid|NaN/.test(new Date(e).toString())
                            );
                        }),
                    ...
                    rangelength: function (e, t, s) {
                        var i = Array.isArray(e) ? e.length : this.getLength(e, t);
                        return this.optional(t) || (i >= s[0] && i <= s[1]);
                    },
                    min: function (e, t, s) {
                    ...
                    step: function (t, s, i) {
                        ...
                        return (n = l(i)), (l(t) > n || h(t) % h(i) != 0) && (c = !1), this.optional(s) || c;
                    },
                    equalTo: function (t, s, i) {
                        var n = e(i);
                        return (
                    ...
                    remote: function (t, s, i, n) {
                        if (this.optional(s)) return "dependency-mismatch";
                        n = ("string" == typeof n && n) || "remote";
                        var a,
                            r,
                            o,
                            l = this.previousValue(s, n);
                        return (
                            this.settings.messages[s.name] || (this.settings.messages[s.name] = {}),
                            (l.originalMessage = l.originalMessage || this.settings.messages[s.name][n]),
                            (this.settings.messages[s.name][n] = l.message),
                                          ...
                                          !0,
                                          {
                                              ...
                                              success: function (e) {
                                                  var i,
                                                      ...
                                                      o,
                                                      h = !0 === e || "true" === e;
                                                  (a.settings.messages[s.name][n] = l.originalMessage),
                                                      h
                                                          ? ((o = a.formSubmitted), a.resetInternals(), (a.toHide = a.errorsFor(s)), (a.formSubmitted = o), a.successList.push(s), (a.invalid[s.name] = !1), a.showErrors())
                                                          : ((i = {}), (r = e || a.defaultMessage(s, { method: n, parameters: t })), (i[s.name] = l.message = r), (a.invalid[s.name] = !0), a.showErrors(i)),
                                                      (l.valid = h),
                                                      a.stopRequest(s, h);
                                              },
                                          },
    ...
    jQuery(document).ready(function (e) {
        function t(t, s) {
            s.length &&
                t.hasClass("active") &&
                (e("body").removeClass("mobile-menu--active"),
                t.removeClass("active animate-end").addClass("animate-reverse"),
                s.stop().fadeOut({ duration: 400, queue: !1 }).slideUp(400),
                setTimeout(function () {
                    t.removeClass("animate-reverse");
                }, 400));
        }
        function s(s, i) {
            s.hasClass("active")
                ...
                : (function (t, s) {
                      s.length &&
                          (t.hasClass("active") ||
                              (e("body").addClass("mobile-menu--active"),
                              t.addClass("active animate"),
                              s.stop().fadeIn({ duration: 400, queue: !1 }).css("display", "none").slideDown(400),
                              setTimeout(function () {
                                  t.addClass("animate-end").removeClass("animate");
                              }, 400)));
                  })(s, i);
        }
        function i() {
            e("select").attr("data-jcf", '{"wrapNative": false, "wrapNativeOnMobile": false, "fakeDropInBody": false, "multipleCompactStyle": true}'),
                jcf.replaceAll(),
                e(".jcf-icon").remove(),
                e(".jcf-select-opener").append("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'><path d='M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z'/></svg>");
        }
        e("body").removeClass("js-inactive").addClass("js-active"),
            ...
            e(".js-toggle-menu").on("click", function (t) {
                t.preventDefault(), s(e(".js-toggle-menu"), e(".site-menu"));
            }),
            e(window).on("scroll", function () {
                t(e(".js-toggle-menu"), e(".site-menu"));
            }),
            e(window).on("resize", function () {
                e(this).width() > 900 && e(".site-menu").css("display", "");
            }),
            e("iframe").wrap('<div class="fitvids-container"></div>'),
            e(".fitvids-container").fitVids(),
            i(),
        ...
        var n = {
            ...
            highlight: function (t) {
                e(t).parents(".form__item").addClass("form__item--error");
            },
            unhighlight: function (t) {
                e(t).parents(".form__item").removeClass("form__item--error");
            },
        };
        e(".js-form-validate").validate(n),
            e(".btn--disabled").on("click", function (e) {
                e.preventDefault();
            });
    });
